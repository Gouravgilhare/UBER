  ...
  return (
    <div>
      <div>
        ...
        <h3 className="text-2xl font-semibold p-4 ">New Ride Available!</h3>
        ...
        <div className="flex gap-2 justify-between items-center flex-col ">
          ...
          <div className="w-full mt-1 flex items-center justify-between ">
            <div className="  bg-gray-200 font-semibold p-3 px-8 rounded-lg  text-black">
              <button
                onClick={() => {
                  props.setRidePopupPanel(false);
                }}
            ...
            <div className="  bg-green-600 font-semibold p-3 px-8 rounded-lg  text-white">
              <button
                onClick={() => {
                  props.setRidePopupPanel(false);
