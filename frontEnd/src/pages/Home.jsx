...
const Home = () => {
  return (
    <div className="h-screen w-full flex flex-col justify-between bg-cover bg-center bg-[url(https://images.unsplash.com/photo-1641124259501-b393df35d654?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-red-400 relative pt-8">
      <img
